...
this.$Facebook_Share ='<a href="http://www.facebook.com/sharer.php?'+
  'u='+this.$url+'">'+
  '<img class="sns_icons" src="'+this.$icon_image_facebook+'">'+
  '</a>';

this.$Googleplus_Share ='<a href="https://plus.google.com/share?'+
  'url='+this.$url+'">'+
  '<img class="sns_icons" src="'+this.$icon_image_google+'">'+
  '</a>';
...
this.$Line_Share ='<a href="https://timeline.line.me/social-plugin/share?'+
  'url='+this.$url+'">'+
  '<img class="sns_icons" src="'+this.$icon_image_line+'">'+
  '</a>';
...
this.$sns_icons.forEach((item,index)=>{
